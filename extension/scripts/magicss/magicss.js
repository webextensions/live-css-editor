                            ...
                            '<div>',
                                ...
                                '<div class="magic-css-edit-file-options">',
                                    '<div class="magic-css-row">',
                                        '<div class="magic-css-row-item-1">Server path:</div>',
                                    ...
                                    '</div>',
                                    '<div class="magic-css-row">',
                                        '<div class="magic-css-row-item-1">&nbsp;</div>',
                                        '<div class="magic-css-row-item-2"><input type="button" value="Check connectivity" /></div>',
                                    '</div>',
                                    '<div class="magic-css-row">',
                                        '<div class="magic-css-row-item-1">File to edit:</div>',
                                        '<div class="magic-css-row-item-2"><input class="magicss-file-to-edit" /></div>',
                                    '</div>',
                                    '<div class="magic-css-row">',
                                        '<div class="magic-css-row-item-1">Link tag to refresh:</div>',
                                        '<div class="magic-css-row-item-2 link-tag-to-refresh"></div>',
                                    '</div>',
                                    '<div class="magic-css-row">',
                                        '<div class="magic-css-row-item-1">Refresh delay:</div>',
                                        '<div class="magic-css-row-item-2"><input type="number" class="magic-css-link-refresh-delay" value="750" min="0" max="60000" step="50" /> milliseconds</div>',
                                    '</div>',
                                    '<div class="magic-css-row">',
